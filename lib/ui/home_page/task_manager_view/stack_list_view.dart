...
class StackListView<T> extends StatefulWidget {
  ...
  final Widget Function(
          BuildContext, double delta, int index, double sizeFactor, T data)
      itemBuilder;
  ...
  Widget build(BuildContext context) {
        ...
        child: FractionalTranslation(
          ...
          child: Transform.scale(
            ...
            child: widget.itemBuilder(
                context, delta, index, thisData.sizeFactor, thisData.data),
          ),
        ),
      );
    }
    ...
    return CustomScrollView(
      ...
      physics: widget.isScrollEnable
          ? physics
          : const NeverScrollableScrollPhysics(parent: physics),
